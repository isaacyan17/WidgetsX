...
STRINGS.WIFI_TRANS_TITLE = 'WidgetsX Demo';
...
STRINGS.CANCEL = '取消';
STRINGS.SELECT_YOUR_FILES = '请选择您要上传到 WidgetsX 的文件';
STRINGS.SUPPORTED_FILE_TYPES = '支持APK/PNG/JPG/DOC/TXT/MP3';
STRINGS.CANNOT_CONNECT_SERVER = '无法连接WidgetsX服务器，请重新打开WidgetsX传输服务并刷新此页后重新操作。';
